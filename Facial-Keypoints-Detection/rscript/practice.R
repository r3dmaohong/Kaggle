...
# parameters
data.dir    <- 'D:\\Work Space\\Kaggle\\Facial-Keypoints-Detection\\input\\'
patch_size  <- 10
search_size <- 2
...
registerDoSNOW(cl)
##in foreach, if you use function in libraries, you should add ".packages="foreach" in the statement.
